...
public class User {
    ...
    public User(String name, String description, Picture picture) {
        this.name = name;
    ...
    public void interact(Post post, int interactionType) {
        post.addInteraction(new Interaction(this, interactionType));
    }
    ...
    public void post(String title, String content) {
        ...
        nPosts[nPosts.length - 1] = new Post(title, content);
        posts = nPosts;
    }
